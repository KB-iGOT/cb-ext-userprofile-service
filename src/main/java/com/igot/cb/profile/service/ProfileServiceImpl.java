...
public class ProfileServiceImpl implements ProfileService {
    ...
    private int getIssuedCertificateCount(String userId) {
        ...
        try {
            return getInternalCoursesCertificateCount(userId) + getEventsCertificateCount(userId) + getExternalCoursesCertificateCount(userId);
        } catch (Exception e) {
    ...
    private int getUserBadgeCount(String userId) {
        ...
        try {
            String cachedValue = cacheService.getCache(redisKey, serverConfig.getBadgeCountRedisIndex());
            ...
            cacheService.putCache(redisKey, totalPoints, serverConfig.getBadgeCountRedisTtl(), serverConfig.getBadgeCountRedisIndex());
            return totalPoints;
